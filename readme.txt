...
Activate the plugin and enter the full URL of an audio file (or playlist) for each section. (Supports all major audio formats. Also, successfully tested with a Shoutcast webradio URL)
