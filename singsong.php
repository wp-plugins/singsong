...
END;
	$postslist = get_posts('numberposts=100&order=ASC&orderby=date');
...
END;
  ...
  <tr>
    ...
    <td width="20%"><input id="volume"  name="volume" value="$volume" size="2"/> Between 1 and 100</td>
    <td width="70%" align="left">&nbsp;</td>
  </tr>
...
$auto = ($auto=='1') ? 'checked':'';
  ...
  <tr>
    ...
    <td width="80%" align="left"><input id="bgc"  name="bgc" value="$bgc" size="7"/>&nbsp;&nbsp;OR&nbsp;&nbsp;<input id="bgi"  name="bgi" value="$bgi" size="7"/>  Color OR Image URL</td>
  </tr>

  <tr>
    <td width="20%"><label for="bgi">Link </label></td>
    <td width="80%" align="left"><input id="title"  name="title" value="$title" size="7"/>&nbsp;&nbsp;OR&nbsp;&nbsp;<input id="but"  name="but" value="$but" size="7"/>  Text OR Image URL</td>
  </tr>
  <tr>
...
function singsong_check() {
	...
	if ((!empty($sshome)) && (is_home())) insert_singsong_code($sshome,$bloop);
	if ((!empty($ssarchive)) && (is_archive())) insert_singsong_code($ssarchive,$bloop);
	if ((is_array($sssingle)) && (is_single())) {
		...
		if ($ssvalue != '') insert_singsong_code($ssvalue,$bloop);
	}
