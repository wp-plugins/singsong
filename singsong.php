...
function singsong_check() {
	...
	if ((!empty($sshome)) && (is_home())) $filepath = $sshome;
	if ((!empty($sssingle)) && (is_single())) $filepath = $sssingle;
	if ((!empty($sspage)) && (is_page()))  $filepath = $sspage;
	if ((!empty($ssarchive)) && (is_archive())) $filepath = $ssarchive;
if (
((!empty($sshome)) && (is_home())) ||
((!empty($sssingle)) && (is_single())) || 
((!empty($sspage)) && (is_page())) || 
